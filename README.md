...
После многочисленных тестов благодаря Диме (Jeckas Nameless) была выявлена небольшая девиация частоты при работе от внутреннего генератора.  
В связи с чем было принято решение автокалибровки от сигнала CLOCK, поступающего на чип из компьютера.
  
Соответственно новые платы ревизии 3.0  
  
**DIP-40 (С кварцем):** [Схема](Export/TurboSound_LGT_40p_Ver3.0.pdf) [Монтаж](Export/TurboSound_LGT_40p_Ver3.0.html) [Gerber](Gerber/TS_LGT_40p_50_Ver3.0_Gerber.zip)  
  
**DIP-28 (С кварцем):** [Схема](Export/TurboSound_LGT_28p_Ver3.0.pdf) [Монтаж](Export/TurboSound_LGT_28p_Ver3.0.html) [Gerber](Gerber/TS_LGT_28p_50_Ver3.0_Gerber.zip)  
  
На обеих платах возможна установка кварцевого генератора с соответствующей прошивкой. Либо использование встроенного генератора с прошивкой автокалибровки.  
  
Предыдущие версии плат легко могут быть доработаны до ревизии 3.0 добавлением одного проводника.
Для 40p соединить 9 ногу LGT8F328P с 22 ногой разъема AY.
А для 28p - 9 ногу LGT8F328P с 15 ногой разъема AY.  
...
* [TS_Emu_INT_Auto_AY](Firmware/AY_Emu_INT_37MHz_Auto_Calib) Внутренний генератор 37 МГц, чип AY-3-8910. Автокалибровка.
...
* [TS_Emu_INT_37MHz_YM](Firmware/YM_Emu_INT_37MHz_Auto_Calib) Внутренний генератор 37 МГц, чип YM2149F. Автокалибровка
...
*   **[Дима](https://t.me/Jeckas_N)** - Спектрумист с идеальным музыкальным слухом.
